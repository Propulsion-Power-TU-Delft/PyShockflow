...
xStart = 2.1            # axial coordinate of nozzle inlet (same reference of the tube)
xEnd = 2.2              # axial coordinate of nozzle outlet (same reference of the tube)
A_throat = 0.1          # throat area of the nozzle (normalized by area of the tube)
