...
ax[1, 1].plot(ideal.xNodes, ideal.solution['Energy'][1:-1, -1]-ideal.solution['Energy'][1, -1], '-C0o', ms=2, label='ideal gas')
ax[1, 1].plot(real.xNodes, real.solution['Energy'][1:-1, -1]-real.solution['Energy'][1, -1], '-C1o', ms=2, mfc='none', label='real gas')
ax[1, 1].set_ylabel(r'Delta Energy')
