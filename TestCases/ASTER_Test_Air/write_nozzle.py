...
"""
GENERATE CSV FILE FOR A NOZZLE RESEMBLING THE ASTER SHAPE. THE AREA VALUES ARE NORMALIZED BY THE TUBE AREA, SO THAT IN THE SIMULATION REFERENCE_AREA CAN BE LEFT TO ONE.
"""

xThroat = 3.0                           # throat axial location
xStart = xThroat - (6+4+7.188)*1E-3     # axial coordinate of nozzle inlet 
...
A_start = 1.0                           # throat area of the nozzle inlet (normalized by area of the tube)
A_end = 1.0                             # throat area of the nozzle outlet (normalized by area of the tube)
...
plt.plot(x, Area, label='Quadratic fit')
plt.xlabel('x [m]')
