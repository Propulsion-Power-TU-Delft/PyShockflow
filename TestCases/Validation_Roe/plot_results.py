...
godFilesLim = ["solutions/Test%i_highOrder.pik" %i for i in range(1,6)]
outFolder = 'pictures'
...
for i in range(len(refFiles)):
    ...
    ax[0, 0].plot(godLim.xNodes, godLim.solution['Density'][1:-1, -1], '--C2', ms=1.5, mfc='none', label='Roe MUSCL-VLeer')
    ...
    ax[0, 1].plot(godLim.xNodes, godLim.solution['Velocity'][1:-1, -1], '--C2', ms=1.5, mfc='none', label='Roe MUSCL-VLeer')
    ...
    ax[1, 0].plot(godLim.xNodes, godLim.solution['Pressure'][1:-1, -1], '--C2', ms=1.5, mfc='none', label='Roe MUSCL-VLeer')
    ...
    ax[1, 1].plot(godLim.xNodes, godLim.solution['Energy'][1:-1, -1], '--C2', ms=1.5, mfc='none', label='Roe MUSCL-VLeer')
