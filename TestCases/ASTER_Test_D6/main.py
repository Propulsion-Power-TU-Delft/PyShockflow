...
NX = 500                                # number of discretization points
TIME_MAX = 0.06                          # adjust as needed
# Gamma = -0.219
TL, TR = 640.85, 573.15                 # left and right initial temperatures
UL, UR = 0.0, 0.0                       # left and right initial velocities
PL, PR = 8.93E+05, 0.02E+05              # left and right initial pressures
# Gamma = -0.016
...
#BOUNDARY_CONDITIONS = 'reflective'     # to mimic the effect of the wall
...
# iNode_Kulite4 = int( NX* ((LENGTH/2) + 0.2) / LENGTH ) # Kulite 4 (representing the sensor in the LPT)
...
# tube.PlotNodeSolution(iNode_Kulite4, folder_name = 'solutions', file_name = 'Solution_at_Kulite4')
tube.SaveNodeSolutionToCSV(iNode_Kulite1, t, folder_name='solutions', file_name='FluidFlowQuantities_at_Kulite1')
tube.SaveNodeSolutionToCSV(iNode_Kulite2, t, folder_name='solutions', file_name='FluidFlowQuantities_at_Kulite2')
tube.SaveNodeSolutionToCSV(iNode_Kulite3, t, folder_name='solutions', file_name='FluidFlowQuantities_at_Kulite3')
